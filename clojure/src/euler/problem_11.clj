...
(defn adj-coords
  ...
  returns a collection of n coordinate pairs beginning with coord and going in
  the direction of dir."
  [coord dir n]
  (map (fn [x] (map + coord (map #(* x %) dir)))
       (range n)))

(defn adj-product
  "Returns the product of the values in the grid vector obtained from the
  coordinates returned by adj-coords."
  [coord dir n]
